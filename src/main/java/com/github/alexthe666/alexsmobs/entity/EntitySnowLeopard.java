...
public class EntitySnowLeopard extends Animal implements IAnimatedEntity, ITargetsDroppedItems {
    ...
    public boolean canTargetItem(ItemStack stack) {
        return stack.has(net.minecraft.core.component.DataComponents.FOOD) && stack.getItem().getFoodProperties(stack, null) != null && true /* TODO 1.21: isMeat() check needs food component */;
    }
